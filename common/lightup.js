...
navigator.userAgent.match(/Opera/gi) && (RightClick = 0),
    ...
    setTimeout(function () {
        ...
        e && e.parentNode.removeChild(e),
            document.getElementById("bannerTopSpacer").style.display = "block"
    }, 6e5);
var minZoom = .2
    , maxZoom = 5
...
var oftmediaIds = [];
oftmediaIds["puzzle-shakashaka.com"] = "14084593",
    oftmediaIds["puzzle-words.com"] = "14241789",
    oftmediaIds["puzzle-futoshiki.com"] = "14529493",
    oftmediaIds["puzzle-skyscrapers.com"] = "16187369",
    oftmediaIds["puzzle-kakurasu.com"] = "16547154",
    oftmediaIds["puzzle-star-battle.com"] = "17119303",
    oftmediaIds["puzzle-tapa.com"] = "17432292",
    oftmediaIds["puzzle-aquarium.com"] = "17492798",
    oftmediaIds["puzzle-masyu.com"] = "18816819",
    oftmediaIds["puzzle-shingoki.com"] = "18980430",
    oftmediaIds["puzzle-heyawake.com"] = "19431444",
    oftmediaIds["puzzle-hitori.com"] = "20167636",
    oftmediaIds["puzzle-pipes.com"] = "20543162";
var oftmediaIds_side = [];
oftmediaIds_side["puzzle-shakashaka.com"] = "14084594",
    oftmediaIds_side["puzzle-words.com"] = "14241806",
    oftmediaIds_side["puzzle-futoshiki.com"] = "14529542",
    oftmediaIds_side["puzzle-skyscrapers.com"] = "16187369",
    oftmediaIds_side["puzzle-kakurasu.com"] = "16547154",
    oftmediaIds_side["puzzle-star-battle.com"] = "17119303",
    oftmediaIds_side["puzzle-tapa.com"] = "17432292",
    oftmediaIds_side["puzzle-aquarium.com"] = "17492798",
    oftmediaIds_side["puzzle-masyu.com"] = "18816819",
    oftmediaIds_side["puzzle-shingoki.com"] = "18980430",
    oftmediaIds_side["puzzle-heyawake.com"] = "19431444",
    oftmediaIds_side["puzzle-hitori.com"] = "20167636",
    oftmediaIds_side["puzzle-pipes.com"] = "20543162";
var adsensePassbacks = {
    ...
    , adUnits = [{
        ...
        bids: [{
            ...
            bidder: "oftmedia",
            params: {
                placementId: "undefined" == typeof oftmediaIds[domain] ? "13876275" : oftmediaIds[domain]
            }
        }]
    }, {
        code: "bannerSide",
        ...
        bids: [{
            ...
            bidder: "oftmedia",
            params: {
                placementId: "undefined" == typeof oftmediaIds_side[domain] ? "13876276" : oftmediaIds_side[domain]
            }
        }]
    }];
...
var defaultSettings = {
    ...
    , puzzleSettings = {
        "light-up.draw-style": is_touch_device() ? "rotate" : "black",
        "light-up.show-crosshair": !1,
        "light-up.touch-mode": "both",
        "light-up.highlight-change": !1,
        "light-up.gray-out-completed": !1,
        "light-up.auto-cross-completed": !1,
        "light-up.mark-error-numbers": !1,
        "light-up.blue-light": !1
    };
defaultSettings = $.extend(!0, defaultSettings, puzzleSettings);
var Settings = {
    bag: localStorage.getItem("puzzleSettings") ? $.extend($.extend(!0, {}, defaultSettings), JSON.parse(localStorage.getItem("puzzleSettings"))) : $.extend(!0, {}, defaultSettings),
    onChange: {},
    store: function (t) {
        MVVM && !t && MVVM.apply();
        try {
    ...
    set: function (t, e, s) {
        return this.bag = localStorage.getItem("puzzleSettings") ? $.extend($.extend(!0, {}, defaultSettings), JSON.parse(localStorage.getItem("puzzleSettings"))) : $.extend(!0, {}, defaultSettings),
            this.bag[t] = e,
...
!function (t) {
    t.fn.lightup = function (e) {
        ...
        return this.currentState = {
            ...
            s.minScale || 7 != s.puzzleWidth || (s.minScale = 1),
            s.minScale || 10 != s.puzzleWidth || (s.minScale = .7),
            s.minScale || 14 != s.puzzleWidth || (s.minScale = .5),
            s.minScale || 25 != s.puzzleWidth || (s.minScale = .4),
            this.getCellsSize = function (t) {
                return t * s.squareSize + s.separatorWidth * (t + 1)
            }
            ,
            this.getBoardWidth = function () {
                return 2 * s.gutter + this.getCellsSize(s.puzzleWidth)
            }
            ,
            this.getBoardHeight = function () {
                return 2 * s.gutter + this.getCellsSize(s.puzzleHeight)
            }
            ,
            this.parseTask = function () {
                if (s.task) {
                    this.currentState.taskStatus = [],
                        this.loaded = !0;
                    for (var e = [], i = 0, r = 0; r < s.task.length; r++)
                        t.isNumeric(s.task[r]) ? (e[i] = s.task[r],
                            i++) : "B" == s.task[r] ? (e[i] = -2,
                                i++) : i += this.decodeChar(s.task[r]);
                    for (var r = 0; r < s.puzzleHeight; r++) {
                        this.task[r] = [],
                            this.currentState.taskStatus[r] = [];
                        for (var i = 0; i < s.puzzleWidth; i++) {
                            var l = r * s.puzzleWidth + i;
                            this.currentState.taskStatus[r][i] = [],
                                "undefined" == typeof e[l] ? this.task[r][i] = -1 : this.task[r][i] = parseInt(e[l])
                        }
                    }
                } else
                    this.loaded = !1;
            ...
            this.initState = function () {
                ...
                for (var t = 0; t < s.puzzleHeight; t++) {
                    this.currentState.taskStatus[t] = [];
                    for (var e = 0; e < s.puzzleWidth; e++)
                        this.currentState.taskStatus[t][e] = []
                }
            ...
            ,
            this.getTaskNeighbours = function (t, e) {
                var i = [];
                return e && i.push({
                    row: t,
                    col: e - 1
                }),
                    e < s.puzzleWidth - 1 && i.push({
                        row: t,
                        col: e + 1
                    }),
                    t && i.push({
            ...
            ,
            this.taskMarkedCount = function (t, e) {
                var i = 0;
                return e && 1 == this.currentState.cellStatus[t][e - 1] && i++,
                    e < s.puzzleWidth - 1 && 1 == this.currentState.cellStatus[t][e + 1] && i++,
                    t && 1 == this.currentState.cellStatus[t - 1][e] && i++,
                    t < s.puzzleHeight - 1 && 1 == this.currentState.cellStatus[t + 1][e] && i++,
                    i
            }
            ,
            this.draw = function () {
                ...
                i = s.gutter,
                    r = s.gutter;
                var l = t('<div class="board-back">').css({
                    position: "absolute",
                    top: i + "px",
                    left: r + "px",
                    width: this.getCellsSize(s.puzzleWidth) + "px",
                    height: this.getCellsSize(s.puzzleHeight) + "px",
                    backgroundColor: "#000",
                    "z-index": "100"
                })
                    , a = t('<div class="print-helper">');
                if (l[0].appendChild(a[0]),
                    this.task.length)
                    for (var o = 0; o < s.puzzleHeight; o++) {
                        this.dom.task[o] = [],
                            this.dom.cells[o] = [];
                        for (var h = 0; h < s.puzzleWidth; h++) {
                            var n = s.squareSize * o + s.separatorWidth * (o + 1)
                                , u = s.squareSize * h + s.separatorWidth * (h + 1);
                            if (this.task[o][h] != -1) {
                                var c = t('<div class="light-up-task-cell" tabindex="1">').css({
                                    position: "absolute",
                                    top: n + "px",
                                    left: u + "px",
                                ...
                                c[0].row = o,
                                    c[0].col = h,
                                    this.task[o][h] > -1 ? c.text(this.task[o][h]) : c.addClass("wall"),
                                    this.dom.task[o][h] = c,
                                    this.dom.cells[o][h] = c,
                                    l[0].appendChild(c[0])
                            } else {
                                var c = t('<div class="cell selectable" tabindex="1">').css({
                                    position: "absolute",
                                    top: n + "px",
                                    left: u + "px",
                                    width: s.squareSize - 2 + "px",
                                ...
                                c[0].row = o,
                                    c[0].col = h,
                                    this.task[o][h] > -1 && c.text(this.task[o][h]),
                                    this.dom.cells[o][h] = c,
                                    l[0].appendChild(c[0])
                            }
                        }
            ...
            this.drawCellStatus = function (t, e) {
                "undefined" == typeof this.dom.task[t.row][t.col] && this.dom.cells[t.row][t.col].toggleClass("cell-off", 0 == e).toggleClass("cell-on icon-lightbulb", 1 == e).toggleClass("cell-x icon-cancel", 2 == e)
            }
            ,
            this.drawCurrentState = function () {
                t(".cell").removeClass("lit err");
                for (var e = 0; e < s.puzzleHeight; e++)
                    for (var i = 0; i < s.puzzleWidth; i++)
                        if (this.drawCellStatus({
                            row: e,
                            col: i
                        }, this.currentState.cellStatus[e][i]),
                            1 == this.currentState.cellStatus[e][i]) {
                            for (var r = i, l = 0; r < s.puzzleWidth - 1 && "undefined" == typeof this.dom.task[e][++r];)
                                this.dom.cells[e][r].addClass("lit"),
                                    1 == this.currentState.cellStatus[e][r] && l++;
                            for (var r = i; r && "undefined" == typeof this.dom.task[e][--r];)
                                this.dom.cells[e][r].addClass("lit"),
                                    1 == this.currentState.cellStatus[e][r] && l++;
                            for (var r = e; r < s.puzzleHeight - 1 && "undefined" == typeof this.dom.task[++r][i];)
                                this.dom.cells[r][i].addClass("lit"),
                                    1 == this.currentState.cellStatus[r][i] && l++;
                            for (var r = e; r && "undefined" == typeof this.dom.task[--r][i];)
                                this.dom.cells[r][i].addClass("lit"),
                                    1 == this.currentState.cellStatus[r][i] && l++;
                            l && this.dom.cells[e][i].addClass("err")
                        }
            ...
            ,
            this.checkCompletedTask = function () {
                t(".completed").removeClass("completed"),
                    t(".task-err").removeClass("task-err");
                for (var e = 0; e < s.puzzleHeight; e++)
                    for (var i = 0; i < s.puzzleWidth; i++)
                        this.task[e][i] > -1 && (Settings.get(this.slug + ".gray-out-completed") && this.taskMarkedCount(e, i) == this.task[e][i] && this.dom.task[e][i].addClass("completed"),
                            Settings.get(this.slug + ".mark-error-numbers") && this.taskMarkedCount(e, i) > this.task[e][i] && this.dom.task[e][i].addClass("task-err"))
            }
            ,
            this.autoCross = function () {
                var t = 0
                    , e = [];
                "undefined" == typeof this.currentState.taskStatus && (this.currentState.taskStatus = []);
                for (var i = 0; i < s.puzzleHeight; i++) {
                    "undefined" == typeof this.currentState.taskStatus[i] && (this.currentState.taskStatus[i] = []);
                    for (var r = 0; r < s.puzzleWidth; r++)
                        if ("undefined" == typeof this.currentState.taskStatus[i][r] && (this.currentState.taskStatus[i][r] = []),
                            this.task[i][r] > -1) {
                            var l = this.getTaskNeighbours(i, r);
                            if (this.taskMarkedCount(i, r) == this.task[i][r])
                                for (var a = 0; a < l.length; a++)
                                    0 == this.getCurrentStatus(l[a]) && (l[a].status = 2,
                                        e.push(l[a]),
                                        this.currentState.taskStatus[i][r].push(l[a]),
                                        t++);
                            else {
                                for (var a = 0; a < this.currentState.taskStatus[i][r].length; a++)
                                    2 == this.getCurrentStatus(this.currentState.taskStatus[i][r][a]) && (this.currentState.taskStatus[i][r][a].status = 0,
                                        e.push(this.currentState.taskStatus[i][r][a]),
                                        t++);
                                this.currentState.taskStatus[i][r] = []
                            }
                        }
                }
                if (t)
                    for (var a = 0; a < e.length; a++)
                        this.setCellState(e[a], e[a].status),
                            this.drawCellStatus(e[a], e[a].status)
            }
            ,
            this.drawHelperHighlightMove = function (e) {
                ...
                (Settings.get(this.slug + ".gray-out-completed") || Settings.get(this.slug + ".mark-error-numbers")) && this.checkCompletedTask(),
                    Settings.get(this.slug + ".auto-cross-completed") && (this.autoCross(),
                        this.autoCross())
            }
            ,
            this.drawHelperNumberOfDrawnCells = function (t, e, s, i) {
                if (Settings.get(this.slug + ".show-magnify") && 1 == this.currentMove.cellStatus) {
                    var r = this.getNumberOfDrawnCells(s, i);
                    r && this.dom.helperNumberOfDrawnCells.show().css({
                        top: e + Layout.scrollTop() - 150 + (Layout.hiddenHeader() ? Config.headerHeight : 0) + "px",
                        left: t + (Settings.get("global.left-handed") ? 25 : -50) + "px"
                    }).html(r)
                }
            }
            ,
            ...
            this.loadState = function (t) {
                if (t.board)
                    for (var e = 0, i = {
                        ...
                        y: 1,
                        x: 2
                    }, r = 0; r < s.puzzleHeight; r++)
                        for (var l = 0; l < s.puzzleWidth; l++) {
                            var a = t.board[e];
                            this.currentState.cellStatus[r][l] = i[a],
                                e++
                        }
            }
            ,
            this.serializeState = function () {
                for (var t = "", e = ["n", "y", "x"], i = 0; i < s.puzzleHeight; i++)
                    for (var r = 0; r < s.puzzleWidth; r++)
                        t += e[this.currentState.cellStatus[i][r]];
                return t
            }
            ,
            this.serializeSolution = function () {
                for (var t = [], e = 0; e < s.puzzleWidth; e++)
                    for (var i = 0; i < s.puzzleHeight; i++)
                        1 == this.currentState.cellStatus[i][e] && t.push(e + "," + i);
                return t.join(";")
            }
            ,
            this.getMarkedCount = function () {
                for (var t = 0, e = 0; e < s.puzzleHeight; e++)
                    for (var i = 0; i < s.puzzleWidth; i++)
            ...
            ,
            this.startMove = function (t, e, s) {
                return "undefined" == typeof this.dom.task[t.row][t.col] && (this.initCurrentMove(),
                    this.drawing = !0,
                    this.currentMove.cellStatus = this.getNextStatus(t, e),
                    this.currentMove.startPoint = {
                        row: t.row,
                        col: t.col
                    },
            ...
            this.getTarget = function (e) {
                var s = this.getChangedTouch(e)
                    ...
                    , r = !1
                    , l = this.getScale();
                "touchstart" != e.type && "touchmove" != e.type && (r = 3 == e.which || 1 == e.which && (e.ctrlKey || e.metaKey),
                    i = !0);
                var a = t(document.elementFromPoint(s.clientX, s.clientY));
                return a.hasClass("board-back") && (a = this.findNearestCell(s.clientX, s.clientY)),
                {
                    target: a,
                    draw: i,
                    scale: l,
            ...
            this.handleTouchStart = function (e) {
                ...
                return target = s.target,
                    ...
                    !(!target || !target.hasClass("cell")) && (this.startMove(target[0], s.inverse, s.draw),
                        void (s.draw && (t(".active").removeClass("active"),
                            this.dragMonitor.decision = "draw")))
            }
            ,
                        ...
                        if (!$this.mouseDown) {
                            if ($this.keyMove = !1,
                                ...
                                90 == t.keyCode && t.ctrlKey ? $this.undo() : 89 == t.keyCode && t.ctrlKey ? $this.redo() : 32 == t.keyCode && "keyboard" == $this.inputMode ? (t.preventDefault(),
                                    $this.keyMove = !0,
                                    $this.startMove($this.currentDomCell[0], !1, !0),
                                    $this.drawing && ($this.zoomingPanning = !1,
                                        $this.endMove(),
                                        $this.setCurrentCell({
                                            row: $this.currentCell.row,
                                            col: $this.currentCell.col
                                        }))) : 17 == t.keyCode && "keyboard" == $this.inputMode ? ($this.keyMove = !0,
                                            $this.startMove($this.currentDomCell[0], !1, !1)) : 16 == t.keyCode && "keyboard" == $this.inputMode ? ($this.keyMove = !0,
                                                $this.startMove($this.currentDomCell[0], !0, !1)) : 27 == t.keyCode ? ($this.inputMode = "mouse",
